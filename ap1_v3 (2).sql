...
--
-- Hôte : localhost:3306
-- Généré le : ven. 21 nov. 2025 à 21:09
...
(11, '2024-11-21', 'maralalalA\r\n', NULL, '2025-11-21 21:53:34', 12);
...
(11, 'test', 'testt', 625221419, 'test', 'test1', 1, 'test@gmail.com', 1, NULL),
(12, 'testtt', 'testt', 625221415, 'testtt', 'test2', 0, 'testt@gmail.com', 1, NULL);
...
--
ALTER TABLE `cr`
  MODIFY `num` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
